...
<tr>
    <td><?=_TITLE; ?></td>
    <td><input type="text" name="catTitle" size="30"/></td>
</tr>
...
<tr>
    <td><?=_PARENT; ?></td>
    <td><?=$ezshop->getCategoryParentCombo("catParentId",0); ?></td>
</tr>

<tr>
    <td><?=_ACTIVE; ?></td>
    <td>
        <input type="radio" name="catActive" value="y" checked/><?=_YES; ?>
        <input type="radio" name="catActive" value="n"/><?=_NO; ?>
    </td>
</tr>
