...
/**
	 ...
	 * @version $Id: class.ShippingPager.php,v 1.2 2008/07/25 02:37:25 redlinesoft Exp $
	 * @access public
	 **/
	class ShippingPager extends ADODB_Pager {
		...
		function RenderGrid()
		{
			...
			<tr>
                ...
                <th class="tblRowSolidTopDown" width="80%"><?=_TYPE; ?></th>
			...
			<tr>
				<td class="tblRowDash" align="center">
					<input type="checkbox" name="mid[]"  value="<?=$this->rs->fields['shpId']; ?>"  class="radioButton" />
				</td>
				<td class="tblRowDash">
					<img src="theme/<?=$mod_lanai->cfg['theme'];?>/images/file.gif" border="0" align="absmiddle">
					<?=$this->rs->fields['shpTitle']; ?>
				</td>
                <td class="tblRowDash" align="center">
                    <?=strtoupper($this->rs->fields['shpRateType']); ?>
                    &nbsp;
                </td>
                <!--
				<td class="tblRowDash" align="center">
				<?
					if ($this->rs->fields['catActive']=='y') {
					    ?>
						<a href="<?=$_SERVER['PHP_SELF']."?modname=".$_REQUEST['modname']; ?>&mf=ezedit&v=n&ac=gactive&mid=<?=$this->rs->fields['shpId']; ?>">
						<img src="theme/<?=$mod_lanai->cfg['theme'];?>/images/ok.gif" border="0" align="absmiddle">
						</a>
						<?
					} else {
						?>
						<a href="<?=$_SERVER['PHP_SELF']."?modname=".$_REQUEST['modname']; ?>&mf=ezedit&v=y&ac=gactive&mid=<?=$this->rs->fields['shpId']; ?>">
                ...
                -->
				<td class="tblRowDash" align="center">
					<a href="<?=$_SERVER['PHP_SELF']."?modname=".$_REQUEST['modname']; ?>&mf=shippingeditform&mid=<?=$this->rs->fields['shpId']; ?>">
