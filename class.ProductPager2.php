...
/**
	 ...
	 * @version $Id: class.ProductPager2.php,v 1.2 2008/07/25 02:37:25 redlinesoft Exp $
	 * @access public
	 **/
	class ProductPager2 extends ADODB_Pager {
		...
		function RenderGrid()
		{
			...
			<tr>
				...
				<th class="tblRowSolidTopDown" width="80%"><?=_TITLE; ?></th>
                <th class="tblRowSolidTopDown" width="80%"><?=_CATEGORY; ?></th>
			...
			<tr>
				<td class="tblRowDash" align="center">
					<input type="checkbox" name="mid[]"  value="<?=$this->rs->fields['prdId']; ?>"  class="radioButton" />
				</td>
				<td class="tblRowDash">
					<img src="theme/<?=$mod_lanai->cfg['theme'];?>/images/file.gif" border="0" align="absmiddle">
					<?=$this->rs->fields['prdTitle']; ?>
				</td>
                <td class="tblRowDash">
                    <?
                        if ($this->rs->fields['catId'] > 0) {
                            $rsparent=$mod_lanai->getCategoryItem($this->rs->fields['catId']);
				...
				<td class="tblRowDash" align="center">
				<?
					if ($this->rs->fields['prdActive']=='y') {
					    ?>
						<a href="<?=$_SERVER['PHP_SELF']."?modname=".$_REQUEST['modname']; ?>&mf=ezedit&v=n&ac=active&mid=<?=$this->rs->fields['prdId']; ?>">
						<img src="theme/<?=$mod_lanai->cfg['theme'];?>/images/ok.gif" border="0" align="absmiddle">
						</a>
						<?
					} else {
						?>
						<a href="<?=$_SERVER['PHP_SELF']."?modname=".$_REQUEST['modname']; ?>&mf=ezedit&v=y&ac=active&mid=<?=$this->rs->fields['prdId']; ?>">
				...
				<td class="tblRowDash" align="center">
					<a href="<?=$_SERVER['PHP_SELF']."?modname=".$_REQUEST['modname']; ?>&mf=prodeditform&ac=edit&mid=<?=$this->rs->fields['prdId']; ?>">
