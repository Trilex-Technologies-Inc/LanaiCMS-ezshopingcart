...
/**
	 ...
	 * @version $Id: class.CategoryPager2.php,v 1.2 2008/07/25 02:37:25 redlinesoft Exp $
	 * @access public
	 **/
	class CategoryPager2 extends ADODB_Pager {
		...
		function RenderGrid()
		{
			...
			<tr>
                ...
                <th class="tblRowSolidTopDown" width="80%"><?=_PARENT; ?></th>
			...
			<tr>
				<td class="tblRowDash" align="center">
					<input type="checkbox" name="mid[]"  value="<?=$this->rs->fields['catId']; ?>"  class="radioButton" />
				</td>
				<td class="tblRowDash">
				...
				<td class="tblRowDash" align="center">
					<a href="<?=$_SERVER['PHP_SELF']."?modname=".$_REQUEST['modname']; ?>&mf=cateditform&ac=gedit&mid=<?=$this->rs->fields['catId']; ?>">
