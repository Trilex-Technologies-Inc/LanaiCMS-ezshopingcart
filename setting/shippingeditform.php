<?php
    ...
    $rs = $ezshop->getShippingMethod($_REQUEST['mid']);
...
<a href="setting.php?modname=<?=$module_name; ?>&mf=shipping">
<?=_BACK; ?></a><br><br>
...
<input type="hidden" name="ac" value="shippingedit">
<input type="hidden" name="mid" value="<?=$_REQUEST['mid']; ?>">

<tr>
    <td><?=_TITLE; ?></td>
    <td><input type="text" name="shpTitle" size="30" value="<?=$rs->fields['shpTitle']; ?>"/></td>
</tr>
...
<tr>
    ...
    <td>
      <input type="radio" name="shpRateType" value="r" <?=$checked_r; ?>/> <?=_EZSHOP_RATETABLE; ?>
      <input type="text" name="shpRateTable" size="40" value="<?=$rs->fields['shpRateTable']; ?>"/>
...
<tr>
    <td>&nbsp;</td>
    <td>
      <input type="radio" name="shpRateType" value="f" <?=$checked_f; ?> /> <?=_EZSHOP_RATEFIXED; ?>
      <input type="text" name="shpFixRate" size="5" value="<?=$rs->fields['shpFixRate']; ?>"/>
    </td>
</tr>
